...
/// macOS implementation of NotificationService
class MacOSNotificationService implements NotificationService {
  ...
  void _onNotificationTapped(NotificationResponse response) {
    ...
    // This can be extended to use a callback system
  }
  ...
  Future<void> show(NotificationOptions options) async {
    ...
    try {
      ...
      final notificationDetails = NotificationDetails(macOS: macOSDetails);
  ...
  Future<PermissionStatus> checkPermission() async {
    try {
      // macOS doesn't have a direct permission check API
      // We check if notifications are enabled at the system level
