...
class AndroidFileService implements FileService {
  ...
  Future<String?> saveFile(FileSaveOptions options, Uint8List data) async {
    try {
      ...
      throw CacheException(message: 'Failed to save file: $e', code: 3003);
    }
  }
  ...
  Future<Uint8List?> readFile(String path) async {
    try {
      ...
      throw CacheException(message: 'Failed to read file: $e', code: 3004);
    }
  }
  ...
  Future<bool> deleteFile(String path) async {
    try {
      ...
      throw CacheException(message: 'Failed to delete file: $e', code: 3005);
    }
  }
  ...
  Future<String?> copyFile(String sourcePath, String destinationPath) async {
    try {
      ...
      throw CacheException(message: 'Failed to copy file: $e', code: 3006);
    }
  }
  ...
  Future<String?> moveFile(String sourcePath, String destinationPath) async {
    try {
      ...
      throw CacheException(message: 'Failed to move file: $e', code: 3007);
    }
  }
